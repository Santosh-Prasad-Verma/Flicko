  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.slowmodeSeconds, slowmodeSeconds) ||
...
abstract mixin class $ChannelModelCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'slowmode_seconds') int slowmodeSeconds,
  ...
  $Res call({
    ...
    return _then(_self.copyWith(
      ...
      slowmodeSeconds: null == slowmodeSeconds
          ? _self.slowmodeSeconds
          : slowmodeSeconds // ignore: cast_nullable_to_non_nullable
              as int,
...
class _ChannelModel implements ChannelModel {
  const _ChannelModel(
      ...
      @JsonKey(name: 'slowmode_seconds') this.slowmodeSeconds = 0,
