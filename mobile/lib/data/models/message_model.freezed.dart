...
mixin _$MessageModel {
 ...
 String get id;@JsonKey(name: 'channel_id') String get channelId;@JsonKey(name: 'author_id') String get authorId; String get content; String get type;@JsonKey(name: 'reply_to_id') String? get replyToId;@JsonKey(name: 'thread_id') String? get threadId; List<AttachmentModel> get attachments; List<ReactionModel> get reactions; bool get pinned; bool get edited;@JsonKey(name: 'edited_at') DateTime? get editedAt;@JsonKey(name: 'created_at') DateTime get createdAt;@JsonKey(name: 'updated_at') DateTime? get updatedAt;// Joined data
 UserModel? get author; MessageModel? get replyTo;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,channelId,authorId,content,type,replyToId,threadId,const DeepCollectionEquality().hash(attachments),const DeepCollectionEquality().hash(reactions),pinned,edited,editedAt,createdAt,updatedAt,author,replyTo);
...
@useResult
$Res call({
 String id,@JsonKey(name: 'channel_id') String channelId,@JsonKey(name: 'author_id') String authorId, String content, String type,@JsonKey(name: 'reply_to_id') String? replyToId,@JsonKey(name: 'thread_id') String? threadId, List<AttachmentModel> attachments, List<ReactionModel> reactions, bool pinned, bool edited,@JsonKey(name: 'edited_at') DateTime? editedAt,@JsonKey(name: 'created_at') DateTime createdAt,@JsonKey(name: 'updated_at') DateTime? updatedAt, UserModel? author, MessageModel? replyTo
});


$UserModelCopyWith<$Res>? get author;$MessageModelCopyWith<$Res>? get replyTo;
...
/// Create a copy of MessageModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? channelId = null,Object? authorId = null,Object? content = null,Object? type = null,Object? replyToId = freezed,Object? threadId = freezed,Object? attachments = null,Object? reactions = null,Object? pinned = null,Object? edited = null,Object? editedAt = freezed,Object? createdAt = null,Object? updatedAt = freezed,Object? author = freezed,Object? replyTo = freezed,}) {
...
as List<AttachmentModel>,reactions: null == reactions ? _self.reactions : reactions // ignore: cast_nullable_to_non_nullable
as List<ReactionModel>,pinned: null == pinned ? _self.pinned : pinned // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'channel_id')  String channelId, @JsonKey(name: 'author_id')  String authorId,  String content,  String type, @JsonKey(name: 'reply_to_id')  String? replyToId, @JsonKey(name: 'thread_id')  String? threadId,  List<AttachmentModel> attachments,  List<ReactionModel> reactions,  bool pinned,  bool edited, @JsonKey(name: 'edited_at')  DateTime? editedAt, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt,  UserModel? author,  MessageModel? replyTo)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MessageModel() when $default != null:
return $default(_that.id,_that.channelId,_that.authorId,_that.content,_that.type,_that.replyToId,_that.threadId,_that.attachments,_that.reactions,_that.pinned,_that.edited,_that.editedAt,_that.createdAt,_that.updatedAt,_that.author,_that.replyTo);case _:
  return orElse();
...
class _MessageModel implements MessageModel {
  const _MessageModel({required this.id, @JsonKey(name: 'channel_id') required this.channelId, @JsonKey(name: 'author_id') required this.authorId, required this.content, this.type = 'default', @JsonKey(name: 'reply_to_id') this.replyToId, @JsonKey(name: 'thread_id') this.threadId, final  List<AttachmentModel> attachments = const [], final  List<ReactionModel> reactions = const [], this.pinned = false, this.edited = false, @JsonKey(name: 'edited_at') this.editedAt, @JsonKey(name: 'created_at') required this.createdAt, @JsonKey(name: 'updated_at') this.updatedAt, this.author, this.replyTo}): _attachments = attachments,_reactions = reactions;
...
@override final  MessageModel? replyTo;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,channelId,authorId,content,type,replyToId,threadId,const DeepCollectionEquality().hash(_attachments),const DeepCollectionEquality().hash(_reactions),pinned,edited,editedAt,createdAt,updatedAt,author,replyTo);
...
@override $UserModelCopyWith<$Res>? get author;@override $MessageModelCopyWith<$Res>? get replyTo;
...
/// Create a copy of MessageModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? channelId = null,Object? authorId = null,Object? content = null,Object? type = null,Object? replyToId = freezed,Object? threadId = freezed,Object? attachments = null,Object? reactions = null,Object? pinned = null,Object? edited = null,Object? editedAt = freezed,Object? createdAt = null,Object? updatedAt = freezed,Object? author = freezed,Object? replyTo = freezed,}) {
...
as List<AttachmentModel>,reactions: null == reactions ? _self._reactions : reactions // ignore: cast_nullable_to_non_nullable
as List<ReactionModel>,pinned: null == pinned ? _self.pinned : pinned // ignore: cast_nullable_to_non_nullable
as bool,edited: null == edited ? _self.edited : edited // ignore: cast_nullable_to_non_nullable
as bool,editedAt: freezed == editedAt ? _self.editedAt : editedAt // ignore: cast_nullable_to_non_nullable
as DateTime?,createdAt: null == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
...
mixin _$AttachmentModel {
 ...
 String get id; String get filename; String get url; int get size;@JsonKey(name: 'content_type') String get contentType; int? get width; int? get height;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,filename,url,size,contentType,width,height);
...
@useResult
$Res call({
 String id, String filename, String url, int size,@JsonKey(name: 'content_type') String contentType, int? width, int? height
});
...
/// Create a copy of AttachmentModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? filename = null,Object? url = null,Object? size = null,Object? contentType = null,Object? width = freezed,Object? height = freezed,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String filename,  String url,  int size, @JsonKey(name: 'content_type')  String contentType,  int? width,  int? height)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AttachmentModel() when $default != null:
return $default(_that.id,_that.filename,_that.url,_that.size,_that.contentType,_that.width,_that.height);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String filename,  String url,  int size, @JsonKey(name: 'content_type')  String contentType,  int? width,  int? height)  $default,) {final _that = this;
switch (_that) {
case _AttachmentModel():
return $default(_that.id,_that.filename,_that.url,_that.size,_that.contentType,_that.width,_that.height);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String filename,  String url,  int size, @JsonKey(name: 'content_type')  String contentType,  int? width,  int? height)?  $default,) {final _that = this;
switch (_that) {
case _AttachmentModel() when $default != null:
return $default(_that.id,_that.filename,_that.url,_that.size,_that.contentType,_that.width,_that.height);case _:
  return null;
...
class _AttachmentModel implements AttachmentModel {
  const _AttachmentModel({required this.id, required this.filename, required this.url, required this.size, @JsonKey(name: 'content_type') required this.contentType, this.width, this.height});
...
/// Create a copy of AttachmentModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? filename = null,Object? url = null,Object? size = null,Object? contentType = null,Object? width = freezed,Object? height = freezed,}) {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ReactionModel&&(identical(other.emoji, emoji) || other.emoji == emoji)&&(identical(other.count, count) || other.count == count)&&(identical(other.me, me) || other.me == me)&&const DeepCollectionEquality().equals(other.users, users));
}
...
class _ReactionModel implements ReactionModel {
  const _ReactionModel({required this.emoji, this.count = 0, this.me = false, final  List<String> users = const []}): _users = users;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ReactionModel&&(identical(other.emoji, emoji) || other.emoji == emoji)&&(identical(other.count, count) || other.count == count)&&(identical(other.me, me) || other.me == me)&&const DeepCollectionEquality().equals(other._users, _users));
}
