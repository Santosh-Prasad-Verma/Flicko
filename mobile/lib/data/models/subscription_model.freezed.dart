...
mixin _$SubscriptionModel {
 ...
 String get id;@JsonKey(name: 'user_id') String get userId; SubscriptionPlan get plan; SubscriptionStatus get status; String get store;@JsonKey(name: 'current_period_start') String? get currentPeriodStart;@JsonKey(name: 'current_period_end') String? get currentPeriodEnd;@JsonKey(name: 'cancel_at_period_end') bool get cancelAtPeriodEnd;@JsonKey(name: 'created_at') String? get createdAt;@JsonKey(name: 'updated_at') String? get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,plan,status,store,currentPeriodStart,currentPeriodEnd,cancelAtPeriodEnd,createdAt,updatedAt);
...
@useResult
$Res call({
 String id,@JsonKey(name: 'user_id') String userId, SubscriptionPlan plan, SubscriptionStatus status, String store,@JsonKey(name: 'current_period_start') String? currentPeriodStart,@JsonKey(name: 'current_period_end') String? currentPeriodEnd,@JsonKey(name: 'cancel_at_period_end') bool cancelAtPeriodEnd,@JsonKey(name: 'created_at') String? createdAt,@JsonKey(name: 'updated_at') String? updatedAt
});
...
/// Create a copy of SubscriptionModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? userId = null,Object? plan = null,Object? status = null,Object? store = null,Object? currentPeriodStart = freezed,Object? currentPeriodEnd = freezed,Object? cancelAtPeriodEnd = null,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
...
as SubscriptionStatus,store: null == store ? _self.store : store // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'user_id')  String userId,  SubscriptionPlan plan,  SubscriptionStatus status,  String store, @JsonKey(name: 'current_period_start')  String? currentPeriodStart, @JsonKey(name: 'current_period_end')  String? currentPeriodEnd, @JsonKey(name: 'cancel_at_period_end')  bool cancelAtPeriodEnd, @JsonKey(name: 'created_at')  String? createdAt, @JsonKey(name: 'updated_at')  String? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SubscriptionModel() when $default != null:
return $default(_that.id,_that.userId,_that.plan,_that.status,_that.store,_that.currentPeriodStart,_that.currentPeriodEnd,_that.cancelAtPeriodEnd,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'user_id')  String userId,  SubscriptionPlan plan,  SubscriptionStatus status,  String store, @JsonKey(name: 'current_period_start')  String? currentPeriodStart, @JsonKey(name: 'current_period_end')  String? currentPeriodEnd, @JsonKey(name: 'cancel_at_period_end')  bool cancelAtPeriodEnd, @JsonKey(name: 'created_at')  String? createdAt, @JsonKey(name: 'updated_at')  String? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _SubscriptionModel():
return $default(_that.id,_that.userId,_that.plan,_that.status,_that.store,_that.currentPeriodStart,_that.currentPeriodEnd,_that.cancelAtPeriodEnd,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(name: 'user_id')  String userId,  SubscriptionPlan plan,  SubscriptionStatus status,  String store, @JsonKey(name: 'current_period_start')  String? currentPeriodStart, @JsonKey(name: 'current_period_end')  String? currentPeriodEnd, @JsonKey(name: 'cancel_at_period_end')  bool cancelAtPeriodEnd, @JsonKey(name: 'created_at')  String? createdAt, @JsonKey(name: 'updated_at')  String? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _SubscriptionModel() when $default != null:
return $default(_that.id,_that.userId,_that.plan,_that.status,_that.store,_that.currentPeriodStart,_that.currentPeriodEnd,_that.cancelAtPeriodEnd,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _SubscriptionModel implements SubscriptionModel {
  const _SubscriptionModel({required this.id, @JsonKey(name: 'user_id') required this.userId, required this.plan, required this.status, this.store = 'stripe', @JsonKey(name: 'current_period_start') this.currentPeriodStart, @JsonKey(name: 'current_period_end') this.currentPeriodEnd, @JsonKey(name: 'cancel_at_period_end') this.cancelAtPeriodEnd = false, @JsonKey(name: 'created_at') this.createdAt, @JsonKey(name: 'updated_at') this.updatedAt});
...
/// Create a copy of SubscriptionModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? userId = null,Object? plan = null,Object? status = null,Object? store = null,Object? currentPeriodStart = freezed,Object? currentPeriodEnd = freezed,Object? cancelAtPeriodEnd = null,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
