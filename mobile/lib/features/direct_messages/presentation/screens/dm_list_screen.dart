                                  ...
                                  if (onlineFriends.isNotEmpty)
                                    SliverToBoxAdapter(
                                      child: OnlineFriendsRow(
                                        ...
                                        onFriendTap: (friend) => context.push('/dms/${friend.id}'),
                                      ),
                                    ),
                                    ...
                                    delegate: SliverChildBuilderDelegate(
                                      (context, index) {
                                        ...
                                        return DMRow(
                                          ...
                                          onTap: () => context.push('/dms/${conversation.id}'),
                                        );
                                      },
  ...
  Widget _buildErrorState(String error, VoidCallback onRetry) {
    return Center(
      child: Column(
        ...
        children: [
          Icon(Icons.error_outline, size: 48, color: const Color(FlickoColors.danger).withValues(alpha: 0.5)),
