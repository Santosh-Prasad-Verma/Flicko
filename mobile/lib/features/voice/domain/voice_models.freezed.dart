...
mixin _$VoiceState {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, channelId, userId, isMuted,
      isDeafened, isVideoEnabled, joinedAt, avatarUrl, displayName);
...
class _VoiceState implements VoiceState {
  const _VoiceState(
      ...
      this.avatarUrl,
      this.displayName});
  factory _VoiceState.fromJson(Map<String, dynamic> json) =>
...
mixin _$VoiceParticipant {
  ...
  bool get isDeafened;
  bool get isLocal;
  bool? get isVideoEnabled; // Future proofing
  DateTime get joinedAt;
  String? get avatarUrl;
  String? get displayName;
  ...
  $VoiceParticipantCopyWith<VoiceParticipant> get copyWith =>
      _$VoiceParticipantCopyWithImpl<VoiceParticipant>(
          this as VoiceParticipant, _$identity);
...
abstract mixin class $VoiceParticipantCopyWith<$Res> {
  factory $VoiceParticipantCopyWith(
          VoiceParticipant value, $Res Function(VoiceParticipant) _then) =
      _$VoiceParticipantCopyWithImpl;
  @useResult
  $Res call(
    ...
    return _then(_self.copyWith(
      ...
      isLocal: null == isLocal
          ...
          : isLocal // ignore: cast_nullable_to_non_nullable
              as bool,
      isVideoEnabled: freezed == isVideoEnabled
          ? _self.isVideoEnabled
          : isVideoEnabled // ignore: cast_nullable_to_non_nullable
              as bool?,
      joinedAt: null == joinedAt
...
extension VoiceParticipantPatterns on VoiceParticipant {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_VoiceParticipant value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
// Future proofing
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$VoiceParticipantCopyWith<_VoiceParticipant> get copyWith =>
      __$VoiceParticipantCopyWithImpl<_VoiceParticipant>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$VoiceParticipantToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$VoiceParticipantCopyWith<$Res>
    implements $VoiceParticipantCopyWith<$Res> {
  factory _$VoiceParticipantCopyWith(
          _VoiceParticipant value, $Res Function(_VoiceParticipant) _then) =
      __$VoiceParticipantCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String participantSid,
