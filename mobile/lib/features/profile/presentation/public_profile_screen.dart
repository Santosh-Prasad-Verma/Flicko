      ...
      builder: (context) => SafeArea(
        child: Column(
          ...
          children: [
            ...
            ListTile(
              leading: const Icon(Icons.link, color: Color(FlickoColors.textPrimary)),
              title: Text(
                'Copy Profile Link',
                style: GoogleFonts.inter(color: const Color(FlickoColors.textPrimary)),
              ),
              onTap: () {
                Clipboard.setData(ClipboardData(text: 'https://flicko.app/u/${widget.userId}'));
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (profile.customStatus != null || profile.customStatusEmoji != null) ...[
                            const SizedBox(height: 8),
                            Row(
                              children: [
                                if (profile.customStatusEmoji != null) ...[
                                  Text(profile.customStatusEmoji!, style: const TextStyle(fontSize: 14)),
            ...
            Container(
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: (_profile?.bannerColors != null && _profile!.bannerColors!.length >= 2)
                    ? [
                        Color(int.parse(_profile!.bannerColors![0].replaceFirst('#', '0xFF'))),
                        Color(int.parse(_profile!.bannerColors![1].replaceFirst('#', '0xFF'))),
                      ]
                    : [
                        _accentColor,
