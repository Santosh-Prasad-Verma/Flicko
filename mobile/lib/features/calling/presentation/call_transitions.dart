...
class CallTransitions {
  ...
  static Future<T?> playPickup<T>(BuildContext context, {
...
class _PickupTransitionState extends State<_PickupTransition> with SingleTickerProviderStateMixin {
      ...
      body: Stack(
        children: [
                  ...
                  Center(
                    child: Opacity(
                      ...
                      child: Container(
                        width: 200,
                        height: 1,
                        color: CallTheme.neonGreen.withValues(alpha: 0.5),
                      ),
                    ),
                  ),
                  Center(
          ...
          AnimatedBuilder(
            ...
            builder: (context, _) {
              return Container(
                color: CallTheme.neonGreen.withValues(alpha: _flashController.value * 0.4),
              );
            },
          ),
          // "LINK LOCKED" text
        ...
        return Scaffold(
          ...
          body: Stack(
            children: [
              ...
              if (t < 0.3)
                Container(
                  color: CallTheme.red.withValues(alpha: (t / 0.3) * 0.3),
                ),
              // Scan lines
              if (t > 0.2 && t < 0.8)
                ...List.generate(10, (i) {
                  final y = (i * 80.0 + t * 200) % MediaQuery.of(context).size.height;
                  return Positioned(
                    top: y,
                    left: 0,
                    right: 0,
                  ...
                  child: Column(
                    ...
                    children: [
                      Icon(
                        ...
                        color: CallTheme.red.withValues(alpha: (1 - t).clamp(0.0, 1.0)),
                        size: 48,
                      ),
                      ...
                      Text(
                        'SESSION CLOSED',
                        style: GoogleFonts.jetBrainsMono(
                          color: CallTheme.textDim.withValues(alpha: (1 - t).clamp(0.0, 1.0)),
                          fontSize: 11,
                          letterSpacing: 3,
                        ),
                      ),
              ...
              if (t > 0.75)
                Container(
                  color: CallTheme.bg.withValues(alpha: ((t - 0.75) / 0.25).clamp(0.0, 1.0)),
                ),
            ],
          ),
        );
...
class _ConnectingOverlayState extends State<_ConnectingOverlay> with SingleTickerProviderStateMixin {
