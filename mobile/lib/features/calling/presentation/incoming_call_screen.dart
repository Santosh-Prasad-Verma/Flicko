...
class _IncomingCallScreenState extends State<IncomingCallScreen>
  ...
  Widget _buildTickerBar() {
    final tickerText =
        'E: 88X-V  ◆  SIG: ${_signalLocked ? 'LOCKED' : 'SCANNING'}  ◆  '
      ...
      child: Row(
        ...
        children: [
          ...
          Column(
            ...
            children: [
              _techLabel('BITRATE: ${_bitrate.toStringAsFixed(1)}MBPS',
                  color: _neonGreen),
    ...
    return Row(
      ...
      children: [
        ...
        AnimatedBuilder(
          ...
          builder: (context, _) {
            final opacity =
                0.3 + 0.7 * (0.5 + 0.5 * sin(_pulseController.value * 2 * pi));
            return Container(
              width: 10,
              height: 10,
              margin: const EdgeInsets.only(right: 10),
              color: _signalLocked
                  ? _neonGreen.withValues(alpha: opacity)
                  : _textDim,
            );
          },
        ),
        ...
        child: SizedBox(
          ...
          child: Stack(
            children: [
              ...
              Center(
                child: Container(width: 260, height: 1, color: _gridColor),
              ),
              Center(
                child: Container(width: 1, height: 260, color: _gridColor),
              ),
