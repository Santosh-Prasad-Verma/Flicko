...
class _OutgoingCallScreenState extends State<OutgoingCallScreen> with TickerProviderStateMixin {
  ...
  Widget _buildTickerBar() {
    const tickerText = 'OUTBOUND ◆ PROTO: FLICKO-RTC/2.0 ◆ ENC: AES-256-GCM ◆ '
          ...
          Column(
            ...
            children: [
              CallTheme.techLabel(
                ...
                color: _signalStrength > 0.5 ? CallTheme.neonGreen : CallTheme.amber,
              ),
              CallTheme.techLabel('NAT: SYMMETRIC', color: CallTheme.neonGreen),
            ],
          ),
        ],
      ),
    ...
    return Row(
      ...
      children: [
        AnimatedBuilder(
          ...
          builder: (context, _) {
            final alpha = 0.3 + 0.7 * (0.5 + 0.5 * sin(_waveController.value * 2 * pi));
            return Container(
              width: 8,
              height: 8,
          ...
          children: [
            ...
            if (_isRinging)
              AnimatedBuilder(
                animation: _radarController,
                builder: (context, _) {
                  final blipAngle = _radarController.value * 2 * pi + pi / 4;
                  return Positioned(
        ...
        children: [
          ...
          ClipRRect(
            ...
            child: LinearProgressIndicator(
              ...
              valueColor: const AlwaysStoppedAnimation<Color>(CallTheme.neonGreen),
            ),
          ),
        ],
      ),
