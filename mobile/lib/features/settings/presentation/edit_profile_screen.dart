...
class _EditProfileScreenState extends ConsumerState<EditProfileScreen> {
  ...
  static final List<Map<String, dynamic>> _bannerColorPresets = [
    {'id': 'lime',     'label': 'Lime',     'colors': const ['#C8FF00', '#0A0A0A']},
  ...
  Future<void> _pickAvatar() async {
    ...
    try {
      ...
      final url = await appwriteService.uploadAttachment(file, 'avatar', 'profile');
      setState(() { _avatarUrl = url; _hasChanges = true; });
    } catch (e) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Failed to upload avatar: $e'), backgroundColor: const Color(FlickoColors.danger)),
        );
      }
    } finally {
  ...
  Future<void> _pickBanner() async {
    ...
    try {
      final appwriteService = ref.read(appwriteStorageServiceProvider);
      final file = File(picked.path);
      final url = await appwriteService.uploadAttachment(file, 'banner', 'profile');
      setState(() { _bannerUrl = url; _hasChanges = true; });
    } catch (e) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Failed to upload banner: $e'), backgroundColor: const Color(FlickoColors.danger)),
        );
      }
    } finally {
      if (mounted) setState(() => _isLoading = false);
  ...
  Future<void> _saveProfile() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        else context.go('/profile/settings');
      }
    } catch (e) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Failed to save: $e'), backgroundColor: const Color(FlickoColors.danger)),
        );
      }
    } finally {
      if (mounted) setState(() => _isLoading = false);
          ...
          child: Row(
            ...
            children: [
              IconButton(
                ...
                onPressed: () => context.canPop() ? context.pop() : context.go('/profile/settings'),
              ),
              Text('EDIT PROFILE',
                style: GoogleFonts.epilogue(
                  color: Colors.white, fontSize: 26,
                  fontWeight: FontWeight.w900, fontStyle: FontStyle.italic, letterSpacing: -1.0,
                ),
              ),
        ...
        children: [
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Expanded(
                      child: Text('@${profile?.username.toUpperCase() ?? "USER"}',
                        style: GoogleFonts.epilogue(
                    ...
                    Container(
                      ...
                      decoration: const BoxDecoration(
                        ...
                        boxShadow: [BoxShadow(color: Color(0x80C8FF00), blurRadius: 15, spreadRadius: 2)],
                      ),
                    ),
                  ],
                ),
              ...
              Container(
                ...
                child: Row(
                  children: [
                    const Icon(Icons.location_on, color: Color(0xFFC8FF00), size: 32),
                    ...
                    Expanded(
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintStyle: GoogleFonts.epilogue(color: Colors.white.withValues(alpha: 0.2)),
          ...
          if (_isLoading)
            const Positioned(
              ...
              child: LinearProgressIndicator(color: Color(0xFFC8FF00), backgroundColor: Colors.black),
            ),
        ],
      ),
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Text('Personalize your identity across Flicko'.toUpperCase(),
            style: GoogleFonts.epilogue(
                      ...
                      children: [
                        _bannerUrl == null
                            ...
                            : _bannerUrl!.startsWith('http')
                                ...
                                : Image.file(File(_bannerUrl!), fit: BoxFit.cover),
                        Center(
                          child: Container(
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: const Color(0xFF0A0A0A),
                      border: Border.all(color: Colors.white, width: 4),
                      boxShadow: const [BoxShadow(color: Color(0xFFC8FF00), offset: Offset(6, 6))],
                    ),
                    child: Stack(
                      fit: StackFit.expand,
                      children: [
                        ...
                        Positioned(
                          ...
                          child: Container(
                            color: const Color(0xFFC8FF00).withValues(alpha: 0.85),
    ...
    return Padding(
      ...
      child: Text(label,
        style: GoogleFonts.inter(
          color: const Color(0xFFC8FF00), fontSize: 10,
  ...
  Widget _buildTextField({
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        counterStyle: GoogleFonts.inter(color: Colors.white.withValues(alpha: 0.2)),
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          return GestureDetector(
            onTap: () => setState(() { _avatarDecoration = decoration['id'] as String; _hasChanges = true; }),
            child: Container(
              width: 100,
              decoration: BoxDecoration(
                color: const Color(0xFF0A0A0A),
                border: Border.all(
                  color: isSelected ? const Color(0xFFC8FF00) : const Color(0xFF333333),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text((decoration['label'] as String).toUpperCase(),
                    style: GoogleFonts.inter(
                      color: isSelected ? const Color(0xFFC8FF00) : Colors.white.withValues(alpha: 0.4),
  ...
  Widget _buildBannerColorPicker() {
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return GestureDetector(
          onTap: () => setState(() { _bannerColors = colors; _hasChanges = true; }),
          child: Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            const Icon(Icons.arrow_forward_ios, color: Color(0xFFC8FF00), size: 16),
          ],
        ),
      ),
    );
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Text('UPDATE $title',
          style: GoogleFonts.epilogue(color: Colors.white, fontWeight: FontWeight.w900, fontSize: 20, letterSpacing: -0.5),
        ),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('Enter URL below:',
              style: GoogleFonts.inter(color: const Color(0xFFC8FF00), fontSize: 12, fontWeight: FontWeight.bold, letterSpacing: 1.2),
            ),
        ...
        actions: [
          TextButton(
            ...
            child: Text('CANCEL', style: GoogleFonts.epilogue(color: Colors.white, fontWeight: FontWeight.w900, fontSize: 14)),
          ),
          ElevatedButton(
            onPressed: () {
              Navigator.of(ctx).pop();
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text('$title updated!', style: GoogleFonts.inter()), backgroundColor: const Color(FlickoColors.success)),
              );
            },
            ...
            child: Text('SAVE', style: GoogleFonts.epilogue(color: Colors.black, fontWeight: FontWeight.w900, fontSize: 14)),
          ),
        ],
      ),
    );
    ...
    return Container(
      ...
      child: Text(
        ...
        style: GoogleFonts.inter(
          ...
          fontSize: 10, fontWeight: FontWeight.bold, letterSpacing: 1.2, height: 1.6,
        ),
      ),
    );
  }
  ...
  Widget _buildAvatarImage(double size) {
    if (_avatarUrl == null) {
      return Container(
        width: size, height: size, color: const Color(0xFF0A0A0A),
        child: Icon(Icons.person, size: size * 0.4, color: Colors.white.withValues(alpha: 0.5)),
      );
    }
    ...
    return Image(
      image: imageProvider, width: size, height: size, fit: BoxFit.cover,
