    ...
    if (picked != null) {
      ...
      try {
        ...
        if (!appwriteService.isConfigured) {
          throw Exception('Media storage is not configured.');
        }
  ...
  Future<void> _saveProfile() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        Future.microtask(() {
          ref.read(authNotifierProvider.notifier).reloadProfile();
        });
      }
    } catch (e) {
      if (mounted) {
  ...
  Widget _buildBannerAndAvatarSection(UserModel? profile) {
    return Column(
      ...
      children: [
        ...
        // Combined section for banner and avatar
        SizedBox(
          height: 240,
          child: Stack(
            ...
            children: [
              ...
              // Avatar overlapping on the left or center to not cover all space
              Positioned(
                top: 100,
                left: 16,
                child: GestureDetector(
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return GestureDetector(
          ...
          child: Container(
            decoration: BoxDecoration(
              color: Color(int.parse(colors[0].replaceFirst('#', '0xFF'))),
              border: Border.all(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text('$title updated successfully!', style: GoogleFonts.inter()),
