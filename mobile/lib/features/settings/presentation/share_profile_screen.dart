...
class ShareProfileScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: authState.maybeWhen(
        authenticated: (user, profile) => _buildBody(context, profile, limeColor),
        orElse: () => const Center(child: Text('Not authenticated', style: TextStyle(color: Colors.white))),
      ),
    );
  }
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [limeColor, Colors.white.withValues(alpha: 0.05), limeColor.withValues(alpha: 0.5)],
                    ...
                    children: [
                      ...
                      Positioned(
                        ...
                        child: Container(
                          ...
                          child: Icon(Icons.verified_rounded, color: limeColor, size: 20),
                        ),
                      ),
                    ],
                  ),
  ...
  Widget _buildActionButton(BuildContext context, String label, IconData icon, VoidCallback onTap, {bool isPrimary = false, required Color limeColor}) {
    return SizedBox(
      width: double.infinity,
      child: Material(
