...
class HelpScreen extends StatelessWidget {
  ...
  final List<_HelpRow> _helpRows = const [
    ...
    _HelpRow(icon: Icons.forum_outlined, label: 'Community', description: 'Join our community server'),
    _HelpRow(icon: Icons.description_outlined, label: 'Terms of Service', description: 'Read our terms of service'),
    _HelpRow(icon: Icons.privacy_tip_outlined, label: 'Privacy Policy', description: 'Read our privacy policy'),
