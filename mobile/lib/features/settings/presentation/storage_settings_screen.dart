      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            ...
            child: Text('Clear', style: GoogleFonts.spaceGrotesk(color: Colors.red, fontWeight: FontWeight.w700)),
          ),
        ],
      ),
    );
            ...
            child: Row(
              ...
              children: [
                ...
                _isClearingCache
                    ...
                    : Icon(Icons.delete_outline, color: Colors.red.withValues(alpha: 0.6), size: 24),
              ],
            ),
          ),
        ),
