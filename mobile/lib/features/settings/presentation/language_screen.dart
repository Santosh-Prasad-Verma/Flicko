  ...
  Widget build(BuildContext context) {
    if (_isLoading) {
      return Scaffold(
        ...
        body: Center(child: CircularProgressIndicator(color: _limeColor, strokeWidth: 2)),
      );
    }
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        leading: IconButton(
          icon: Icon(Icons.arrow_back_ios_new_rounded, color: _limeColor, size: 20),
            ...
            child: Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintStyle: GoogleFonts.inter(color: Colors.white24, fontSize: 14, fontWeight: FontWeight.w500),
                  prefixIcon: Icon(Icons.search_rounded, color: _limeColor, size: 22),
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(color: isSelected ? _limeColor.withValues(alpha: 0.2) : Colors.transparent),
                            ),
                            child: Center(
                              child: Text(
                                lang.prefix,
