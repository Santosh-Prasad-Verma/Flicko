          ...
          TextButton(
            onPressed: () async {
              ...
              try {
                ...
                if (mounted) {
                  messenger.showSnackBar(SnackBar(content: Text('Error disabling account: $e')));
                }
              }
            },
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            ...
            child: Text('I understand, delete', style: GoogleFonts.spaceGrotesk(color: Colors.red, fontWeight: FontWeight.w700)),
          ),
        ],
      ),
    );
