...
import 'package:mobile/features/sonic_music/CustomWidgets/animated_text.dart';
                    ...
                    PopupMenuButton(
                      ...
                      onSelected: (int? value) {
                        ...
                        if (value == 20) {
                          ...
                          audioHandler.customAction('switchToYouTube', {'id': mediaItem.id});
                          ShowSnackBar().showSnackBar(
                            context,
                        ...
                        if (value == 21) {
                          Feedback.forLongPress(context);
                          audioHandler.customAction('switchToSaavn', {'id': mediaItem.id});
                          ShowSnackBar().showSnackBar(
                            context,
