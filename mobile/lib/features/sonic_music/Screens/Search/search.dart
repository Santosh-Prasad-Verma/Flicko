...
import 'package:mobile/features/sonic_music/CustomWidgets/media_tile.dart';
import 'package:mobile/features/sonic_music/CustomWidgets/search_bar.dart'
    as searchbar;
...
import 'package:mobile/features/sonic_music/Screens/Common/song_list_view.dart';
import 'package:mobile/features/sonic_music/Screens/Search/albums.dart';
import 'package:mobile/features/sonic_music/Screens/Search/artists.dart';
import 'package:mobile/features/sonic_music/Screens/YouTube/youtube_artist.dart';
...
class _SearchPageState extends State<SearchPage> {
    ...
    switch (searchType) {
      case 'ytm':
        ...
        YtMusicService()
            ...
            .then((value) {
          setState(() {
            final songSections = value.where(
              (element) => element['title'] == 'Songs',
            );
            if (songSections.isNotEmpty) {
              songSections.first['allowViewAll'] = true;
            }
            searchedList = value;
            fetched = true;
          });
                                                                    ...
                                                                    ? () async {
                                                                        if (itemType ==
                                                                          ...
                                                                          Navigator
                                                                            ...
                                                                            context,
                                                                            MaterialPageRoute(
                                                                              builder: (context) => YouTubeArtist(
                                                                                artistId: items[index]['id'].toString(),
                                                                              ),
                                                                            ),
                                                                          );
                                                                        }
  ...
  List<Widget> getChoices(
    ...
    return choices.map((Map<String, String> element) {
      final bool isSelected = searchType == element['key'];
      return Padding(
