...
mixin _$ServersState {
  ...
  List<ChannelModel> get selectedServerChannels;
  String? get selectedServerId; // null means "Home" view
  bool get isLoading;
  ...
  $ServersStateCopyWith<ServersState> get copyWith =>
      _$ServersStateCopyWithImpl<ServersState>(
          this as ServersState, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ServersState &&
            const DeepCollectionEquality().equals(other.servers, servers) &&
            const DeepCollectionEquality()
                .equals(other.selectedServerChannels, selectedServerChannels) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(selectedServerChannels),
      selectedServerId,
      isLoading,
      errorMessage);
...
abstract mixin class $ServersStateCopyWith<$Res> {
  factory $ServersStateCopyWith(
          ServersState value, $Res Function(ServersState) _then) =
      _$ServersStateCopyWithImpl;
  @useResult
  $Res call(
      {List<ServerModel> servers,
      List<ChannelModel> selectedServerChannels,
...
/// @nodoc
class _$ServersStateCopyWithImpl<$Res> implements $ServersStateCopyWith<$Res> {
  ...
  $Res call({
    Object? servers = null,
    Object? selectedServerChannels = null,
    ...
    return _then(_self.copyWith(
      servers: null == servers
          ...
          : servers // ignore: cast_nullable_to_non_nullable
              as List<ServerModel>,
      selectedServerChannels: null == selectedServerChannels
          ? _self.selectedServerChannels
          : selectedServerChannels // ignore: cast_nullable_to_non_nullable
              as List<ChannelModel>,
      selectedServerId: freezed == selectedServerId
          ? _self.selectedServerId
...
extension ServersStatePatterns on ServersState {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ServersState value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _ServersState() when $default != null:
        return $default(_that.servers, _that.selectedServerChannels,
            _that.selectedServerId, _that.isLoading, _that.errorMessage);
      case _:
        return orElse();
    }
  }
...
class _ServersState implements ServersState {
  const _ServersState(
      ...
      final List<ChannelModel> selectedServerChannels = const [],
      this.selectedServerId,
      this.isLoading = false,
      this.errorMessage})
      : _servers = servers,
        _selectedServerChannels = selectedServerChannels;
  ...
  @JsonKey()
  List<ChannelModel> get selectedServerChannels {
    if (_selectedServerChannels is EqualUnmodifiableListView)
      return _selectedServerChannels;
    // ignore: implicit_dynamic_type
...
// null means "Home" view
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ServersStateCopyWith<_ServersState> get copyWith =>
      __$ServersStateCopyWithImpl<_ServersState>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ServersState &&
            const DeepCollectionEquality().equals(other._servers, _servers) &&
            const DeepCollectionEquality().equals(
                other._selectedServerChannels, _selectedServerChannels) &&
            (identical(other.selectedServerId, selectedServerId) ||
                other.selectedServerId == selectedServerId) &&
            (identical(other.isLoading, isLoading) ||
                other.isLoading == isLoading) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_selectedServerChannels),
      selectedServerId,
      isLoading,
      errorMessage);
...
/// @nodoc
abstract mixin class _$ServersStateCopyWith<$Res>
    implements $ServersStateCopyWith<$Res> {
  factory _$ServersStateCopyWith(
          _ServersState value, $Res Function(_ServersState) _then) =
